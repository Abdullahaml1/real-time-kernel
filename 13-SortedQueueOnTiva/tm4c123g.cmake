...
# A bug flags "section .init LMA [00000000000005ac,00000000000005af] overlaps section .data LMA [00000000000005ac,00000000000005b7]"
set(BUG_FLAGS "-nostartfiles")


set(CPU "-mcpu=cortex-m4")
set(FPU "-mfpu=fpv4-sp-d16 -mfloat-abi=hard")
set(CMAKE_ASM_FLAGS "${CMAKE_ASM_FLAGS} -mthumb ${CPU}  ${FPU} -MD")
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -mthumb ${CPU} ${FPU} -g -std=gnu99 -Os -ffunction-sections -fdata-sections -MD -Wall -pedantic ${BUG_FLAGS}")
